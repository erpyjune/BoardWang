 ...
 */
public class RuliwebExtractorCar {
    private static Logger logger = Logger.getLogger(RuliwebExtractorCar.class.getName());
        ...
        for (Element element : elements) {
            ...
            for (Element docSubElement : docSubElements) {
                ...
                for (Element docLinkElement : docLinkElements) {
                    board.setUrl("http://bbs1.ruliweb.daum.net/gaia/do/ruliweb/default/hobby/2459/" + docLinkElement.attr("href"));
...
//                }
    ...
    void testExtract(String bodyFilePath) throws Exception {
        ...
        RuliwebExtractorCar cp = new RuliwebExtractorCar();
