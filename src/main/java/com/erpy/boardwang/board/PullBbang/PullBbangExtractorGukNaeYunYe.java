 ...
 */
public class PullBbangExtractorGukNaeYunYe {
    private static Logger logger = Logger.getLogger(PullBbangExtractorGukNaeYunYe.class.getName());
...
//                }
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/PullBbangGukNaeYunYe_441130786.html", "utf-8");
        sourceMap.put("data", body);
        pullBbangExtractorGukNaeYunYe.extractList(sourceMap);
    }
}
