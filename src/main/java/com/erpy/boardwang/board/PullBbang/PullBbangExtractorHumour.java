 ...
 */
public class PullBbangExtractorHumour {
    private static Logger logger = Logger.getLogger(PullBbangExtractorHumour.class.getName());
...
//                }
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/PullBbangHumour_99184983.html", "utf-8");
        sourceMap.put("data", body);
        pullBbangExtractorHumour.extractList(sourceMap);
    }
}
