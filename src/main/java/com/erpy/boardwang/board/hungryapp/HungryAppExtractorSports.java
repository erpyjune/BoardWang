 ...
 */
public class HungryAppExtractorSports {
    private static Logger logger = Logger.getLogger(HungryAppExtractorSports.class.getName());
        ...
        for (Element element : elements) {
            ...
            for (Element docSubElement : docSubElements) {
                ...
                for (Element docLinkElement : docLinkElements) {
                    ...
                    board.setUrl("http://www.hungryapp.co.kr/bbs/bbs_view.php?pid=" + boardNum + "&bcode=soccertalk");
...
//
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/HungryAppSports_499142135.html", "utf-8");
        sourceMap.put("data", body);
        hungryAppExtractorSports.extractList(sourceMap);
    }
}
