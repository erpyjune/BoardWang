 ...
 */
public class HungryExtractorHumour extends Board {
    private static Logger logger = Logger.getLogger(HungryExtractorHumour.class.getName());
        ...
        for (Element element : elements) {
            ...
            for (Element docSubElement : docSubElements) {
                ...
                for (Element docLinkElement : docLinkElements) {
                    ...
                    board.setUrl("http://www.hungryapp.co.kr/bbs/bbs_view.php?pid=" + boardNum + "&bcode=humor");
