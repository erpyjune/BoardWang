 ...
 */
public class TodayHumourExtractorBestOfBest {
    private static Logger logger = Logger.getLogger(TodayHumourExtractorBestOfBest.class.getName());
...
//        }
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/TodayHumourBestOfBest_882893237.html", "utf-8");
        sourceMap.put("data", body);
        todayHumourExtractorBestOfBest.extractList(sourceMap);
    }
}
