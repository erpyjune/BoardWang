 ...
 */
public class DaumAgoraExtractorFood {
    private static Logger logger = Logger.getLogger(DaumAgoraExtractorFood.class.getName());
...
//                }
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/DaumAgoraFood_597055243.html", "utf-8");
        sourceMap.put("data", body);
        daumAgoraExtractorFood.extractList(sourceMap);
    }
}
