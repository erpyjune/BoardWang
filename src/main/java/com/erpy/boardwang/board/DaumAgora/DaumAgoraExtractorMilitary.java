 ...
 */
public class DaumAgoraExtractorMilitary {
    private static Logger logger = Logger.getLogger(DaumAgoraExtractorMilitary.class.getName());
...
//                }
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/DaumAgoraMilitary_988078908.html", "utf-8");
        sourceMap.put("data", body);
        daumAgoraExtractorMilitary.extractList(sourceMap);
    }
}
