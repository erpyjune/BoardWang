 ...
 */
public class DaumAgoraExtractorJicJjick {
    private static Logger logger = Logger.getLogger(DaumAgoraExtractorJicJjick.class.getName());
...
//                }
    ...
    public Board extractContent(String body) throws Exception {
        ...
        for (Element element : elements) {
            ...
            for (Element docSubElement : docSubElements) {
                logger.info(docSubElement.outerHtml());
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/DaumAgoraJicJjick_641443195.html", "utf-8");
        sourceMap.put("data", body);
        daumAgoraExtractorJicJjick.extractList(sourceMap);
    }
}
