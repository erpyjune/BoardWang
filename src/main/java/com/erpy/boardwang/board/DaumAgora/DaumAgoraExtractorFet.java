 ...
 */
public class DaumAgoraExtractorFet {
    private static Logger logger = Logger.getLogger(DaumAgoraExtractorFet.class.getName());
...
//                }
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/DaumAgoraFet_165415487.html", "utf-8");
        sourceMap.put("data", body);
        daumAgoraExtractorFet.extractList(sourceMap);
    }
}
