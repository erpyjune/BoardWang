 ...
 */
public class DocDripExtractorHotDog {
    private static Logger logger = Logger.getLogger(DocDripExtractorHotDog.class.getName());
...
//                }
    ...
    public static void main(String args[]) throws Exception {
        ...
        String body = stdFile.fileReadToString("/Users/oj.bae/Work/BoardWang/crawl_data/DocDripHotDog_577262167.html", "utf-8");
        sourceMap.put("data", body);
        docDripExtractorHotDog.extractList(sourceMap);
    }
}
