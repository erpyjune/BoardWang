 ...
 */
public class AppZzangExtractorInGi {
    private static Logger logger = Logger.getLogger(AppZzangExtractorInGi.class.getName());
...
//                }
    ...
    void testExtract(String bodyFilePath) throws Exception {
        ...
        appZzangExtractorInGi.extractList(sourceMap);
    }
    ...
    void testExtractBody(String bodyUrl) throws Exception {
        ...
        Board board = appZzangExtractorInGi.extractContent(crawlContent.execute(bodyUrl, "utf-8"));
    ...
    public static void main(String args[]) throws Exception {
        AppZzangExtractorInGi appZzangExtractorInGi = new AppZzangExtractorInGi();
        appZzangExtractorInGi.testExtract("/Users/oj.bae/Work/BoardWang/crawl_data/AppZzangInGi_847129057.html");
