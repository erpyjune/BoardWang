 ...
 */
public class PpombbuExtractorIngi {
    private static Logger logger = Logger.getLogger(PpombbuExtractorIngi.class.getName());
...
//                }
    ...
    void testExtract(String bodyFilePath) throws Exception {
        ...
        PpombbuExtractorIngi ppombbuExtractorJage = new PpombbuExtractorIngi();
    ...
    public static void main(String args[]) throws Exception {
        PpombbuExtractorIngi ppombbuExtractorJage = new PpombbuExtractorIngi();
        ppombbuExtractorJage.testExtract("/Users/oj.bae/Work/BoardWang/crawl_data/PpombbuJageIngi_735491159.html");
